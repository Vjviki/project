...
//Scenario 1
app.get('/todos/', validateFields, async (request, response) => {
...
app.get('/agenda/', validateFields, async (request, response) => {
...
//API 4
app.post('/todos/', validateFields, async (request, response) => {
...
//API 5
app.put('/todos/:todoId/', validateFields, async (request, response) => {
  const {todoId} = request.params
  const getDetails = request.body
